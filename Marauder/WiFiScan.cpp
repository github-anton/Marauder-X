...
void WiFiScan::RunSetup() {
  ...
  settings->loadSetting<bool>("ChanHop");
...
bool WiFiScan::joinWiFi(String ssid, String password, bool gui) {
  ...
  settings->saveSetting<bool>("ClientSSID", ssid);
  settings->saveSetting<bool>("ClientPW", password);
...
void WiFiScan::initWiFi(uint8_t scan_mode) {
  ...
  if (scan_mode != WIFI_SCAN_OFF) {
    ...
    this->force_pmkid = settings->loadSetting<bool>(text_table4[5]);
    this->force_probe = settings->loadSetting<bool>(text_table4[6]);
    this->save_pcap = settings->loadSetting<bool>(text_table4[7]);
    this->ep_deauth = settings->loadSetting<bool>("EPDeauth");
    settings->loadSetting<String>("ClientSSID");
    settings->loadSetting<String>("ClientPW");
...
void WiFiScan::RunEapolScan(uint8_t scan_mode, uint16_t color) {
  ...
  this->send_deauth = settings->loadSetting<bool>(text_table4[5]);
...
void WiFiScan::channelHop(bool filtered, bool ranged) {
  ...
  if ((!settings->loadSetting<bool>("ChanHop")) &&
